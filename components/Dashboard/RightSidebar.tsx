...
const HotTrendsData = [
  ...
  },
  {
    ...
    time: "1d",
    content:
      "Some experiences don't just teach you, they shape you. I just wrapped up... Read more",
    image: "",
    likes: 97,
    comments: 30,
  },
        ...
        <div className="flex flex-col gap-y-4">
          {ConnectWithData.map((person, idx) => (
            <div key={idx} className="flex items-center justify-between">
              ...
              <Button
                size="sm"
                className="h-8 rounded-full bg-[#0D52D2] hover:bg-[#0D52D2]/90 text-white px-5 text-xs font-semibold"
              >
                Follow
              </Button>
            </div>
