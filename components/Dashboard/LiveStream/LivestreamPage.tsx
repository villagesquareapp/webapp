...
//   setCurrentTab: (tab: "For You" | "Following") => void;
// }
...
//           )}
//           onClick={() => setCurrentTab(tab as "For You" | "Following")}
//         >
//           {tab}
//         </span>
//       ))}
...
//   // Determine if there is content to show
//   const showContent =
//     currentTab === "For You" && (liveStreams || featuredLivestream.length > 0);
...
//       {featuredLivestream.length === 0 && (!liveStreams || liveStreams.length === 0) ? (
//         <NotFoundResult
//           title="No Live streams available at the moment"
//           content={
//             <p>
...
const LivestreamPage = () => {
  ...
  const [isLoading, setIsLoading] = useState<boolean>(true);
  const [currentTab, setCurrentTab] = useState<"For You" | "Following">("For You");
  const [selectedFilter, setSelectedFilter] = useState(LIVE_STREAM_FILTERS);
  ...
  const showContent = currentTab === "For You" && (liveStreams || featuredLivestream.length > 0);
  const showEmptyState = !isLoading && !showContent;
