...
const SvgVFlixOutline = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg viewBox="0 0 20.5 20.5" fill="none" className="svg-icon" {...props}>
      <path
...
export default SvgVFlixOutline;
