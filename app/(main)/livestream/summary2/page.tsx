...
export default function LiveSummary2Page() {
  return (
    <div className="flex h-full overflow-hidden">
      ...
      {/* Right Sidebar: Top Gifters */}
      <div className="w-[400px] shrink-0 border-l border-white/5 overflow-y-auto no-scrollbar p-5">
        <div className="bg-[#232325] rounded-xl p-5 flex flex-col h-full">
              ...
              <div key={i} className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {gifter.rank && (
                      <span className="text-[#8E8E93] text-[10px] bg-white/5 px-2 py-0.5 rounded-full font-medium">{gifter.rank}</span>
                    )}
                  </div>
                </div>
